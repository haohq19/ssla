...
from utils.ela_utils import tensor_cache
...
def prepare_chunk_indices(
    ...
    # [0, 0, ..., 0, 1, 1, ..., 1, ...]  each element is the sequence index of the chunk
    # [0, 1, ..., N_1 - 1, 0, 1, ..., N_2 - 1, ...]  each element is the chunk index within the sequence
...
def prepare_chunk_offsets(
    ...
    # [0, N_1, N_2, ..., N_B] -> [0, N_1, N_1 + N_2, ..., N_1 + ... + N_B]
